...
class InitMission(object):
    ...
    def __init__(self, aircraft_name='A320', engine_name='V2500', aircraft_data_path='./DataBase/aircraft.json',
        ...
        self.electric_component_density = (2.5 + 8.3) / (2.5 * 8.3) * 0.5  # Electric energy density
        ...
        if self.max_payload_weight is None:
    ...
    def load_mission_config(self, mission_data_path):
        ...
        self.electric_component_density = self.electric_component_density  # Electric energy density
