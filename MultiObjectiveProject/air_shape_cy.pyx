...
cpdef calc_normal_airshape(str aircraft_name, str aircraft_data_path, init_mission_class, engine_weight_class, list engine_mounting_positions, double other_args):
    cdef air_shape_class
    air_shape_class = NormalShape(aircraft_name, init_mission_class, engine_weight_class, engine_mounting_positions, other_args)

    air_shape_class.run_airshape(aircraft_data_path, drawing=False, tuning=False)

    return air_shape_class

cpdef calc_bwb_airshape(str aircraft_type, init_mission_class, list thermal_design_variables, list init_shape_params, list data_base_args, double other_args):

    air_shape_class = BlendedWingBodyShape(aircraft_type, init_mission_class, thermal_design_variables, init_shape_params, data_base_args, other_args)
